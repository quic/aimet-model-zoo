# PyTorch Transformer model Vision Transformer(ViT) for Image Classification 
...
# Example
python transformer_imageclassification.py --model_name_or_path vit  --model_eval_type fp32  --per_device_eval_batch_size 4 --train_dir <imagenet_train_path> --validation_dir <imagenet_val_path> --per_device_eval_batch_size 8 
```
