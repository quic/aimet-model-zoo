...
OFFICIAL_URL_HEAD = "https://github.com/quic/aimet-model-zoo/releases/download/torch_vit"
...
def download_weights():
    ...
    OFFICIAL_URL_TAR = f"{OFFICIAL_URL_HEAD}/imgnet_vit_5e4_clamp_rl.tar.gz"
    urllib.request.urlretrieve(
