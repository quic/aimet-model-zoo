...
from aimet_zoo_torch.regnet.dataloader.dataloaders_and_eval_func import eval_func, forward_pass
...
def arguments():
    ...
    parser.add_argument('--model-config', help='model configuration to use', default="regnet_x_3_2gf_w8a8", 
