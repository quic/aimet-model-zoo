...
#  @@-COPYRIGHT-END-@@
# =============================================================================
"""Class for downloading and setting up of optmized and original Bert model for AIMET model zoo"""
import json
import os
import sys
import pathlib
...
# transformers import
from aimet_zoo_torch.bert.model import baseline_models
...
class Bert(Downloader):
    ...
    def __init__(self, model_config=None, args=None):
        if model_config == "bert_w8a8_squad":
            ...
            from aimet_zoo_torch.bert.model.utils.utils_nlclassifier_dataclass import (
                ModelArguments,
                DataTrainingArguments,
                AuxArguments,
            )
