...
#  @@-COPYRIGHT-END-@@
# =============================================================================
"""Class for downloading and setting up of optmized and original roberta model for AIMET model zoo"""
...
# transformers import
from aimet_zoo_torch.roberta.model import baseline_models
...
class Roberta(Downloader):
    ...
    def __init__(self, model_config=None, args=None):
        if model_config == "roberta_w8a8_squad":
            ...
            from aimet_zoo_torch.roberta.model.utils.utils_nlclassifier_dataclass import (
                ModelArguments,
                DataTrainingArguments,
                AuxArguments,
            )
