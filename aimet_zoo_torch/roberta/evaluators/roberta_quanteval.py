...
"""AIMET Quantization evaluation code of Roberta model"""
...
from aimet_zoo_torch.roberta import Roberta
...
def main():
    ...
    # get datasets 
    datasets=get_datasets(data_args=model.data_args,training_args=model.training_args,model_args=model.model_args,model=model_orig,tokenizer=tokenizer)

    # evaluation of original model 
    original_eval_results=eval_function(model_orig,tokenizer,datasets,model.data_args,model.training_args)

    # get quantsim object 
    quantsim_model = model.get_quantsim()

    # evaluation of quantsim model 
    optimized_eval_results=eval_function(quantsim_model.model,tokenizer,datasets,model.data_args,model.training_args)
