...
#  @@-COPYRIGHT-END-@@
# =============================================================================
"""Class for downloading and setting up of optmized and original mobilebert model for AIMET model zoo"""
import json
import os
import sys
import pathlib
...
# transformers import
from aimet_zoo_torch.mobilebert.model import baseline_models
...
class MobileBert(Downloader):
    ...
    def __init__(self, model_config=None, args=None):
        if model_config == "mobilebert_w8a8_squad":
            ...
            from aimet_zoo_torch.mobilebert.model.utils.utils_nlclassifier_dataclass import (
                ModelArguments,
                DataTrainingArguments,
                AuxArguments,
            )
