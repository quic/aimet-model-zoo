...
from aimet_zoo_torch.ffnet.dataloader.cityscapes.utils.trnval_utils import eval_minibatch
...
def arguments():
    ...
    parser.add_argument('--model-config',         help='Select the model configuration', type=str, default="segmentation_ffnet78S_dBBB_mobile", choices=[
    ...
    parser.add_argument('--dataset-path',       help='Path to cityscapes parent folder containing leftImg8bit', type=str, default='')
...
def main(args):
    ...
    # Get Dataloader
    train_loader, val_loader, eval_func = get_dataloaders_and_eval_func(dataset_path = config.dataset_path, batch_size = config.batch_size, num_workers = 4)
