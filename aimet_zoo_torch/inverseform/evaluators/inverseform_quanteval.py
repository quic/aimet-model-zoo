...
def arguments():
    parser = argparse.ArgumentParser(description='Evaluation script for PyTorch InverseForm models.')
    parser.add_argument('--model-config',         help='Select the model configuration', type=str, default="hrnet_16_slim_if", choices=[
        "hrnet_16_slim_if",
        "ocrnet_48_if"])
...
def main():
	...
	_, val_loader, eval_func = get_dataloaders_and_eval_func(dataset_path=args.dataset_path)
