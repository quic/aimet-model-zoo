...
class MobileNetV2(Downloader):
    ...
    def __init__(
            self, model_config=None, num_classes=1000, input_size=224, width_mult=1.0
    ):
        ...
        if model_config:
            ...
            self.model = Mobile_Net_V2(
                n_class=self.cfg["model_args"]["num_classes"],
            ...
            self.model = Mobile_Net_V2(
                n_class=num_classes, input_size=input_size, width_mult=width_mult
            )
    ...
    def from_pretrained(self, quantized=False):
        ...
        if quantized:
            ...
            quantized_state_dict["state_dict"][
                "classifier.weight"
            ] = quantized_state_dict["state_dict"]["classifier.1.weight"]
            del quantized_state_dict["state_dict"]["classifier.1.weight"]
            quantized_state_dict["state_dict"][
                "classifier.bias"
            ] = quantized_state_dict["state_dict"]["classifier.1.bias"]
