...
"""Class for downloading and setting up of optmized and original SESR model for AIMET model zoo"""
...
class SESR(SESRRelease, Downloader):
    ...
    def __init__(
        ...
        self.num_lblocks = (
            self.cfg["model_args"]["num_lblocks"] if self.cfg else num_lblocks
        )
        if self.cfg:
            Downloader.__init__(
                self,
