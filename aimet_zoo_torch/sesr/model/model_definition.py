...
class SESR(SESRRelease, Downloader):
    ...
    def __init__(self, model_config=None, num_channels=16, scaling_factor=2, num_lblocks=3,**kwargs):
        """
        ...
        self.num_lblocks = self.cfg['model_args']['num_lblocks'] if self.cfg else num_lblocks
        if self.cfg:
        ...
        SESRRelease.__init__(self, 
                             scaling_factor = self.scaling_factor,
                             num_channels = self.num_channels,
                             num_lblocks = self.num_lblocks,
                             **kwargs)
