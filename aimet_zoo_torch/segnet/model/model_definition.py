...
"""Class for downloading and setting up of optmized and original segnet model for AIMET model zoo"""
import os
import json
import pathlib
import torch
...
from aimet_zoo_torch.segnet.model.models.segnet import (
    get_seg_model,
)

class SegNet(Downloader):
    """SegNet parent class with automated loading of weights and providing a QuantSim with pre-computed encodings"""

    def __init__(self, model_config=None, device=torch.device("cuda")):
        """
