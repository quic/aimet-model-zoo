...
class XLSR(XLSRRelease, Downloader):
    ...
    def __init__(self, model_config=None, scaling_factor=2, **kwargs):
        """
        ...
        XLSRRelease.__init__(self, 
                             scaling_factor = self.cfg['model_args']['scaling_factor'] if self.cfg else scaling_factor,
                             **kwargs)
