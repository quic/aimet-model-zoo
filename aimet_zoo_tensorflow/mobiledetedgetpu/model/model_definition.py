...
#  @@-COPYRIGHT-END-@@
# =============================================================================
"""Class for downloading and setting up of optmized and original mobiledetedgetpu model for AIMET model zoo"""
import os
import json
import pathlib
...
class MobileDet(Downloader):
    """Wrapper class for loading Tensorflow MobileDet"""
