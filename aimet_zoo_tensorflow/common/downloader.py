...
class Downloader():
    ...
    def __init__(self, 
        ...
        self.path_pre_opt_weights = os.path.join(self._download_storage_path, "pre_opt_weights") if self.url_pre_opt_weights else None
        self.path_post_opt_weights = os.path.join(self._download_storage_path, "post_opt_weights") if self.url_post_opt_weights else None
        self.path_adaround_encodings = os.path.join(self._download_storage_path,"adaround_encodings") if self.url_adaround_encodings else None
        self.path_aimet_encodings = os.path.join(self._download_storage_path, "aimet_encodings") if self.url_aimet_encodings else None
        self.path_aimet_config = os.path.join(self._download_storage_path,"aimet_config") if self.url_aimet_config else None
        self.path_zipped_checkpoint = os.path.join(self._download_storage_path, "zipped_checkpoint.zip") if self.url_zipped_checkpoint else None
